...
export const metadata = {
  title: 'Login — Discworld Ledger',
}

export default function LoginPage() {
  return (
    <AuthPageShell title="he Ledger Awaits" subtitle="Sign in to continue thy reading journey">
      <AuthForm mode="login" />
      <p className="font-medieval mt-4 text-center text-sm text-[#7a5a20]">
        No account yet?{' '}
        <Link
          href="/register"
          className="font-semibold text-[#5a3a10] underline hover:text-[#8b6a20]"
        >
          Register thy name
        </Link>
      </p>
